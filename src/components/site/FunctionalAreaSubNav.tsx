...
export function FunctionalAreaSubNav() {
  ...
  return (
    <nav
      ...
      aria-label="ניווט באזור האימון הפונקציונלי"
    >
      <div className="mx-auto flex max-w-7xl gap-2 overflow-x-auto px-4 py-3 [-webkit-overflow-scrolling:touch]">
        <button
          ...
          aria-current="page"
          onClick={() => scrollToSection(FUNCTIONAL_SCHEDULE_SECTION_ID)}
        >
          לו&quot;ז השיעורים
        </button>
        <button
          ...
          onClick={() => scrollToSection(FUNCTIONAL_PRICING_SECTION_ID)}
        >
          מחירון
        </button>
      </div>
