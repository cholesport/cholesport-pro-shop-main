...
import { FunctionalAreaSubNav } from "@/components/site/FunctionalAreaSubNav";
import { FunctionalPricingSection } from "@/components/site/FunctionalPricingSection";
import { FunctionalScheduleSection } from "@/components/site/FunctionalScheduleSection";
...
export function FunctionalAreaHubPage() {
  return (
    <div dir="rtl">
      <section
        className="relative overflow-hidden border-b border-border"
        aria-labelledby="functional-hub-heading"
      >
